...
/*package*/ class PersonsContainer_TABULAR_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PersonsContainer_TABULAR_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_vp8nfp_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_vp8nfp_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_vp8nfp_a0a");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_vp8nfp_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
    ...
    _FunctionTypes._void_P0_E0 creator = () -> {
      EditorCacheHacks.noCaching(editorContext, () -> {
        try {
          ...
          final Grid childGrid = createChildsVertical_vp8nfp_a2a(editorContext, node);
          ...
          editorCell.value.setCellId("Table_vp8nfp_c0");
  ...
  public Grid createChildsVertical_vp8nfp_a2a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);


    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.persons$raqM)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.persons$raqM);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.persons$raqM)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.persons$raqM)).getElement(y) : null), LINKS.persons$raqM);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.persons$raqM)).isEmpty()) {
      EditorCell placeholder = new EditorCellFactory(editorContext, node, grid).createPlaceholderConstant("<no persons>");
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.persons$raqM, editorContext);
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink persons$raqM = MetaAdapterFactory.getContainmentLink(0x4832870850814e8cL, 0x8f0506019d4c5f64L, 0x222e912402a02fc3L, 0x222e912402a02fddL, "persons");
  }
}
